<?php
    ...
    $select = "SELECT * FROM sub_reg WHERE Semester='2' AND username='{$user}'";
    $sql = mysqli_query($conn,$select);
    $i=1;
    $num_rows = mysqli_num_rows($sql);
    if(!$num_rows){
      echo "<div style='color: red; font-weight: bold; font-size: 30px;'>You have not Registered for 2nd Semester...!!</div>";
    }else{
...
<head>
  ...
  <title>CSE | 2nd Semester</title>
</head>

<body>
  <h1 class="myh1">1st Year 2nd Semester Computer Science & Engineering Subjects</h1>
  <div class="forms">
