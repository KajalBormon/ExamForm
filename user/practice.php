                ...
                <form class="myform" method="POST" action="">
                    <div class="info_center">
                        ...
                        <div class="profile_img">
                            <img heigh="110" width="90" src="../css/images/logo.png" alt="">
                        </div>
                    </div>
                    <div>
                        <table width="100%">
                            ...
                            <tr>
                                <td>Student Name: Kajal Chandra Bormon</td>
                                <td>Registration No.: 6725</td>
                                <td>Session: 2017-18</td>
                            </tr>
                            <tr>
                                <td>Roll No.: 18102017</td>
                                <td>Exam date: 10-02-2020</td>
                            </tr>
                        </table>
                    </div>
                    <table width="100%">
