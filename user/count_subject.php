<?php
    ...
    $first_sem = "SELECT * FROM sub_reg WHERE Semester='1' AND username='{$user}'";
    ...
    // For 2nd semester...................
    include "../connection.php";
    $second_sem = "SELECT * FROM sub_reg WHERE Semester='2' AND username='{$user}'";
    ...
    // For 3rd semester...................
    include "../connection.php";
    $third_sem = "SELECT * FROM sub_reg WHERE Semester='3' AND username='{$user}'";
    ...
    // For 4th semester...................
    include "../connection.php";
    $fourth_sem = "SELECT * FROM sub_reg WHERE Semester='4' AND username='{$user}'";
    ...
    // For 5th semester...................
    include "../connection.php";
    $fifth_sem = "SELECT * FROM sub_reg WHERE Semester='5' AND username='{$user}'";
    ...
    // For 6th semester...................
    include "../connection.php";
    $six_sem = "SELECT * FROM sub_reg WHERE Semester='6' AND username='{$user}'";
    ...
    // For 7th semester...................
    include "../connection.php";
    $seventh_sem = "SELECT * FROM sub_reg WHERE Semester='7' AND username='{$user}'";
    ...
    // For 8th semester...................
    include "../connection.php";
    $eitgh_sem = "SELECT * FROM sub_reg WHERE Semester='8' AND username='{$user}'";
