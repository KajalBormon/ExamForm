<?php
    ...
    $query1 = "SELECT * FROM registration JOIN sem_reg ON registration.username = sem_reg.username WHERE semester='2'";
...
<body>
    ...
    <br /><br /><br /><br /><br /><br />
    <h2 style="color:#ff0000;font-family:'Acme';" class = "page-header"><u>Students Registered For 1st Year 1st Semester</u></h2>
