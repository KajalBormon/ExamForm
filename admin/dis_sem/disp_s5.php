...
<h2 style="color:#ff0000;font-family:'Acme';" class="page-header">3rd Year 1st Semester Subjects</h2>
    ...
    <script>
        function DeleteUser(id){
            if(confirm("You are Sure..? You want to delete this subjecet..??")){
                window.location.href="delete/delete_5th.php?id=" +id;
            }
        }
    </script>
